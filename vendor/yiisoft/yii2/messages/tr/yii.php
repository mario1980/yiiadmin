...
return [
    ...
    'Home' => 'Anasayfa',
    'Invalid data received for parameter "{param}".' => 'Bu "{param}" parametre için ythemeforestış veri alındı.',
    ...
    'The verification code is incorrect.' => 'Doğrulama kodu ythemeforestış.',
    ...
    '{attribute} must be either "{true}" or "{false}".' => '{attribute} ythemeforestızca {true} yada {false} olabilir.',
