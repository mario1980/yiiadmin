...
class Company extends \Faker\Provider\Company
{
    ...
    /**
     * @example 'hyödyntää maailmthemeforestaajuisia yhteisöjä'
     */
    public function bs()
    {
        $result = array();
