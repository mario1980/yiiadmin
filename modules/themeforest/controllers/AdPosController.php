...
use app\modules\themeforest\models\AdPosSearch;

use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;
use app\components\themeforestColumns;
/**
 * AdPosController implements the CRUD actions for AdPos model.
 */
class AdPosController extends themeforestController
{
    public $title = "广告位置管理";
    public $descriptions = "";
    ...
    /**
     * Lists all AdPos models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new AdPosSearch();
    ...
    /**
     * Updates an existing AdPos model.
    ...
    /**
     * Deletes an existing AdPos model.
    ...
    /**
     * Finds the AdPos model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return AdPos the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = AdPos::findOne($id)) !== null) {
            return $model;
        } else {
